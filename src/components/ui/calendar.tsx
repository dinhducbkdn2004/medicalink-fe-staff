		...
		<DayPicker
			...
			classNames={{
				...
				button_previous: cn(
					...
					"h-[2rem] w-[2rem] p-0 select-none aria-disabled:opacity-50",
				...
				month_caption: cn(
					"flex h-[2rem] w-full items-center justify-center px-[2rem]",
					defaultClassNames.month_caption
				),
				dropdowns: cn(
					"flex h-[2rem] w-full items-center justify-center gap-1.5 text-sm font-medium",
...
function CalendarWeekNumber({
	...
	return (
		<td {...props}>
			<div className="flex size-[2rem] items-center justify-center text-center">
				{children}
			</div>
		</td>
	);
...
function CalendarDayButton({
	...
	return (
		<Button
			...
			className={cn(
				"data-[selected-single=true]:bg-primary data-[selected-single=true]:text-primary-foreground data-[range-middle=true]:bg-accent data-[range-middle=true]:text-accent-foreground data-[range-start=true]:bg-primary data-[range-start=true]:text-primary-foreground data-[range-end=true]:bg-primary data-[range-end=true]:text-primary-foreground group-data-[focused=true]/day:border-ring group-data-[focused=true]/day:ring-ring/50 flex aspect-square h-auto w-full min-w-[2rem] flex-col gap-1 leading-none font-normal group-data-[focused=true]/day:relative group-data-[focused=true]/day:z-10 group-data-[focused=true]/day:ring-[3px] data-[range-end=true]:rounded-md data-[range-middle=true]:rounded-none data-[range-start=true]:rounded-md [&>span]:text-xs [&>span]:opacity-70",
				defaultClassNames.day,
				className
			)}
			{...props}
