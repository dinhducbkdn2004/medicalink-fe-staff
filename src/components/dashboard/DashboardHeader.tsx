...
export const DashboardHeader = ({
	...
	return (
		<header className="bg-sidebar flex h-13 shrink-0 items-center gap-2 border-b transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12">
