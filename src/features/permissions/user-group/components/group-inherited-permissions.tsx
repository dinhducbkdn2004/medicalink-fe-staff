  ...
  return (
    <div className='border-muted mt-2 rounded-md border'>
      <button
        ...
        className='hover:bg-muted/40 flex w-full items-center justify-between gap-2 px-3 py-2 text-left text-sm font-medium'
      >
              ...
              <div key={mod.moduleId} className='space-y-2'>
                ...
                <div className='grid gap-2 sm:grid-cols-2'>
                  {mod.resources.map(({ resource, permissions }) => (
                    ...
                    >
                      <div className='mb-2 flex items-center gap-1.5 text-sm font-medium capitalize text-foreground'>
                        ...
                        {permissions.map((p) => {
                          ...
                          return (
                            <Badge
                              ...
                              variant='outline'
                              className={cn(
                                'flex items-center gap-1.5 border px-2 py-0.5 text-xs font-normal transition-colors',
                                allowed
                            ...
                            >
                              ...
                              {hasConditions && (
                                <span
                                  className='ml-0.5 border-l pl-1.5 text-[10px] opacity-70'
                                  title='Có điều kiện'
                                >
